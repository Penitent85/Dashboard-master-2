...
export default function ProductsDemo() {
    ...
    const confirmDeleteProduct = (product) => {
        ...
        const callFun = async () => {
            try {
                await axios.delete(`${import.meta.env.VITE_BACKEND_URL}api/pharmacies/${product.id}`, {
                    headers: {
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="flex flex-row">
                <Link to={`/pharmacy/view/${rowData.id}`}>
                ...
                <Link to={`/pharmacy/edit/${rowData.id}`}>
    ...
    const header = (
        <div className="align-items-center justify-content-between flex flex-wrap gap-2">
            <h4 className="m-0">Manage Pharmacy</h4>
