...
const ModifyEditComponent = ({ onSuccess }) => {
    const { id } = useParams();
    console.log(id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`${import.meta.env.VITE_BACKEND_URL}api/categories/${id}`, dataPayload, {
                headers: {
                    Authorization: `${import.meta.env.VITE_AUTH_KEY}`,
                    "ngrok-skip-browser-warning": "sss",
                },
    ...
    return (
        <div className="card">
            <h1 className="mb-6 text-2xl font-bold text-gray-800 dark:text-gray-100">Edit Specialization</h1>
            <form
            ...
            >
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Arabic Specialization Name</label>
                        <input
                            type="text"
                            name="ar_name"
                    ...
                    <div>
                        <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">English Specialization Name</label>
                        <input
                            type="text"
                            name="en_name"
...
export default ModifyEditComponent;
