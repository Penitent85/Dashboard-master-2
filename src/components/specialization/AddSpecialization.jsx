...
console.log(formData);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(`${import.meta.env.VITE_BACKEND_URL}api/categories`, form, {
                headers: {
    ...
    return (
        <div className="card">
            <h1 className="mb-6 text-2xl font-bold text-gray-800 dark:text-gray-100">Create Specialization</h1>
            <form
